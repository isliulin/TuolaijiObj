...
typedef struct {
   uint32_t CSR;     /**< Systemtick Control and Status Register , offset: 0x0 */
   uint32_t RVR;     /**< Systemtick Reload Value High, offset: 0x4 */
   uint32_t CVR;     /**< Systemtick Current Value Register , offset: 0x8 */
   uint32_t CALIB;   /**< Systemtick Calibration Value Register , offset: 0xC */
}SYSTICK_Type;
