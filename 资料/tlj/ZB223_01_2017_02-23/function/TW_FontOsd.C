...
BYTE DMAMODE_RW_FIX_REG;
BYTE DMAMODE_RW_INC_REG;
BYTE DMAMODE_R_XDATA;
BYTE DMAMODE_W_XDATA;
BYTE SPICMD_READ;
BYTE SPICMD_PROGRAM;
BYTE SPICMD_BYTES;
image_header_info_t header_table;
BYTE TVPowerStability_Flag;
...
{
	SelfKeyStruct valueTemp;
	valueTemp.Data =  value ;
	I2C_SCL_PDDR_OUT;
	I2C_SDA_PDDR_OUT;	
	I2C_SCL_L;      
        if(valueTemp.b.Key7)I2C_SDA_H;    //I2C_SDA=valueTemp.b.Key7;
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key6;	
        if(valueTemp.b.Key6) I2C_SDA_H;    //I2C_SDA=valueTemp.b.Key7;
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key5;	
        if(valueTemp.b.Key5)I2C_SDA_H;    
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key4;	
        if(valueTemp.b.Key4)I2C_SDA_H;   
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key3;	
        if(valueTemp.b.Key3)I2C_SDA_H;    
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key2;	
        if(valueTemp.b.Key2) I2C_SDA_H;    
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key1;	
        if(valueTemp.b.Key1) I2C_SDA_H;    
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
	I2C_SCL_L;	//I2C_SDA=valueTemp.b.Key0;	
        if(valueTemp.b.Key0)I2C_SDA_H;    
        else I2C_SDA_L;	
        dd();///dd();
		I2C_SCL_H;	dd();
  /*
	I2C_SCL_L;	I2C_SDA=(value & 0x80)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x40)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x20)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x10)? 1:0;	I2C_SCL_H;	dd();

	I2C_SCL_L;	I2C_SDA=(value & 0x08)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x04)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x02)? 1:0;	I2C_SCL_H;	dd();
	I2C_SCL_L;	I2C_SDA=(value & 0x01)? 1:0;	I2C_SCL_H;	dd();
  */
	//I2C_SCL_L;	
	I2C_SCL_L;	
	//I2C_SCL_L;
...
//	I2C_SCL_H;	valueTemp.b.Key7=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;  valueTemp.b.Key6=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key5=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key4=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key3=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key2=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key1=I2C_SDA;	I2C_SCL_L;	dd();
//	I2C_SCL_H;	valueTemp.b.Key0=I2C_SDA;	I2C_SCL_L;	dd();
	...
	I2C_SCL_L;
	dd2();///dd();
	I2C_SDA_PDDR_OUT;			///as output
	
	return value;
//return valueTemp.Data;
...
{
	TV_POWER_5V_MUX();TV_POWER_5V_PDDR_OUT;
	I2C_SCL_MUX();
	I2C_SDA_MUX();
	MODE_CTRL_MUX();
	DOWNLOAD_CTRL_MUX();
	...
	///SPI下载程序的切换
	DOWNLOAD_CTRL_PDDR_OUT;
	DOWNLOAD_CTRL_L;
	MODE_CTRL_PDDR_OUT;
	MODE_CTRL_L;
	///信号输入
	//ISD_MISO_IO=1;(ap:输入为啥是1？)
	ISD_MISO_PDDR_IN;
        ISD_MISO_L;
	///信号输出脚
	ISD_MOSI_PDDR_OUT;
	ISD_MOSI_L;
	///时钟脚
	ISD_SCLK_PDDR_OUT;//ISD_SCLK_IO=0;
	 ISD_SCLK_L;//ISD_SCLK=0;
	///使能脚
	ISD_CS_PDDR_OUT;//ISD_CS_IO=0; 
	ISD_CS_L;//ISD_CS=0;
	///I2C程序的端口
	I2C_SCL_PDDR_OUT;
	I2C_SDA_PDDR_OUT;
...
//	TV_POWER_5V_DIR = 1;
	if(State==0)
		TV_POWER_5V_L;//TV_POWER_5V = 0;
	else
		TV_POWER_5V_H;//TV_POWER_5V = 1;
}
/***************************************************************************
一、程序类型（底层驱动、应用层、初始化）：初始化
二、功能描述：
...
(WORD OsdRamAddr, BYTE Back_Front_Color,  BYTE  *str,BYTE Cnt, BYTE mode)
{
  ...
  status = 	   (ReadTW88(0x05) & 0xFE) ;
  
	WriteTW88( 0x05,  status | (BYTE)(OsdRamAddr >> 8));
	st =  OsdRamAddr>>8;
	 ...
	 if(st==0) 
	  {
	     if(OsdRamAddr>0xff) 
	      {
	       WriteTW88( 0x05, status | 1);
	       st = 1;
	      }  
	  }  
		WriteTW88( 0x06, (BYTE)(OsdRamAddr) ); 
...
1、
***************************************************************************/
void WriteClearStringToAddr(WORD OsdRamAddr, BYTE Back_Front_Color,  BYTE  str,BYTE Cnt, BYTE mode)
{
	BYTE i,st;//st1;
  BYTE  status;
	WriteTW88Page( PAGE3_FOSD);
...
unsigned char TW88XX_WatchDog_Flag;
