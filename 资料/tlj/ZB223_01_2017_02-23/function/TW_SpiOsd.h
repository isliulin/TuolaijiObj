#ifndef __TW_SPIOSD_H_
#define __TW_SPIOSD_H_
...
EXT BYTE TVPowerStability_Flag;
////////////////////////////////////////////////////////////////////////////////////////////////////
...
//void SetPictureInfo(UINT8 window,const PIC_INFO_STRUCT *__far pPicInfo);
void SOsdHwBuffWrite2Hw(void);
//void SetPictureInfo(UINT8 window,const PIC_INFO_STRUCT *__far pPicInfo,UINT16 x,UINT16 y);
void WriteClearStringToAddr(WORD OsdRamAddr, BYTE Back_Front_Color,  BYTE  str,BYTE Cnt, BYTE mode);
void OpenPicture(void);
